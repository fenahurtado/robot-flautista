...
t0 = time()
pierre = Musician(host, connections, event, fingers_connect=False, x_connect=True, z_connect=False, alpha_connect=False, flow_connect=False, preasure_sensor_connect=False)
pierre.start()
